...
export default class NeonAdapter extends BaseAdapter {
    ...
    constructor(options: AdapterOptions) {
        super(options);
        const neonOptions = options as NeonAdapterOptions;
        this.apiKey = neonOptions.apiKey || getEnvValue("NEON_API_KEY");
        this.projectId = neonOptions.projectId || getEnvValue("NEON_PROJECT_ID");
     ...
     */
    async validateOptions(): Promise<boolean> {
     ...
     */
    async checkResources(connectionString: string): Promise<void> {
